    ...
    public class Atelier : Microsoft.Xna.Framework.Game
    {
        ...
        void GérerTransition()
        {
            ...
            switch (ÉtatJeu)
            {
                ...
                case GameState.JEU:
                    if (GestionInput.EstNouvelleTouche(Keys.Escape) || GestionManettes.EstNouvelleTouche(PlayerIndex.One, Buttons.Start) || GestionManettes.EstNouvelleTouche(PlayerIndex.Two, Buttons.Back))
                    {
